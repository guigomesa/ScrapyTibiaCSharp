...
namespace TibiaApi.BotWeb.Pipelines
{
    public class WorldListPipeline : EntityPipeline
    {
        ...
        protected override int Process(List<IBaseEntity> items, dynamic sender = null)
        {
            ...
            {
                Hangfire.RecurringJob.AddOrUpdate<WorldSpider>(url.Name, spider=> spider.Run(url.Url), Hangfire.Cron.MinuteInterval(15), queue: Constantes.FilasHangfire.WORLD_SCRAPY);
            }
